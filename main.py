...
class GoogleKeywordScreenshooter:
  ...
  def start(self):
    ...
    try:
      related_questions = WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, "//span[contains(text(), '관련 질문')]/../../../../..")))
    ...
    for i, result in enumerate(search_results):
      ...
      #   print(title.text)
      try:
        result.screenshot(str(self.screenshots_dir / f"{self.keyword}_{i + 1:02}.png"))
      except:
        pass
    self.finish()
